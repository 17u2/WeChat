...
.field public static khc:Loicq/wlogin_sdk/tools/b;

.field public static khd:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Loicq/wlogin_sdk/tools/util;->kgK:I

    .line 60
    const/16 v0, 0x80

    sput v0, Loicq/wlogin_sdk/tools/util;->kgL:I

    .line 62
    sput v1, Loicq/wlogin_sdk/tools/util;->kgM:I

    .line 63
    sput v2, Loicq/wlogin_sdk/tools/util;->kgN:I

    .line 64
    const/4 v0, 0x2

    sput v0, Loicq/wlogin_sdk/tools/util;->kgO:I

    .line 65
    const/4 v0, 0x3

    sput v0, Loicq/wlogin_sdk/tools/util;->kgP:I

    .line 66
    const/4 v0, 0x4

    sput v0, Loicq/wlogin_sdk/tools/util;->kgQ:I

    .line 67
    sput v3, Loicq/wlogin_sdk/tools/util;->kgR:I

    .line 68
    const/4 v0, 0x6

    sput v0, Loicq/wlogin_sdk/tools/util;->kgS:I

    .line 69
    const/4 v0, 0x7

    sput v0, Loicq/wlogin_sdk/tools/util;->kgT:I

    .line 70
    const/16 v0, 0x8

    sput v0, Loicq/wlogin_sdk/tools/util;->kgU:I

    .line 71
    const/16 v0, 0x9

    sput v0, Loicq/wlogin_sdk/tools/util;->kgV:I

    .line 72
    const/16 v0, 0xa

    sput v0, Loicq/wlogin_sdk/tools/util;->kgW:I

    .line 73
    const/16 v0, 0xb

    sput v0, Loicq/wlogin_sdk/tools/util;->kgX:I

    .line 74
    const/16 v0, 0xc

    sput v0, Loicq/wlogin_sdk/tools/util;->kgY:I

    .line 75
    const/16 v0, 0xd

    sput v0, Loicq/wlogin_sdk/tools/util;->kgZ:I

    .line 76
    const/16 v0, 0xe

    sput v0, Loicq/wlogin_sdk/tools/util;->kha:I

    .line 79
    sput v2, Loicq/wlogin_sdk/tools/util;->khb:I

    .line 83
    const/4 v0, 0x0

    sput-object v0, Loicq/wlogin_sdk/tools/util;->khc:Loicq/wlogin_sdk/tools/b;

    .line 84
    sput-boolean v1, Loicq/wlogin_sdk/tools/util;->khd:Z

    .line 86
    sput v3, Loicq/wlogin_sdk/tools/util;->khe:I
...
.method private static DH(Ljava/lang/String;)[B
    .locals 4
...
.method public static DI(Ljava/lang/String;)V
    ...
    .line 503
    :try_start_0
    sget v0, Loicq/wlogin_sdk/tools/util;->khb:I

    if-lez v0, :cond_0

    .line 504
    sget-object v0, Loicq/wlogin_sdk/tools/util;->khc:Loicq/wlogin_sdk/tools/b;
    ...
    invoke-virtual {v0, v1, p0}, Loicq/wlogin_sdk/tools/b;->k(ILjava/lang/String;)V
    ...
    .line 507
    :cond_1
    sget-boolean v0, Loicq/wlogin_sdk/tools/util;->khd:Z
    ...
    invoke-static {}, Loicq/wlogin_sdk/tools/util;->aYN()Ljava/lang/String;
...
.method public static a(Landroid/content/Context;[B)V
    ...
    .prologue
    .line 381
    invoke-static {p0}, Loicq/wlogin_sdk/tools/util;->fs(Landroid/content/Context;)[B
    ...
    invoke-static {p1}, Loicq/wlogin_sdk/tools/util;->bg([B)Ljava/lang/String;
...
.method public static bf([B)[B
    ...
    .line 178
    invoke-static {v1}, Loicq/wlogin_sdk/tools/c;->be([B)[B
...
.method public static bj(Landroid/content/Context;Ljava/lang/String;)[B
    .locals 3
...
.method public static bk(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/c;->be([B)[B
    :try_end_0
...
.method public static c(Ljava/lang/Exception;)V
    ...
    invoke-static {v1, v0}, Loicq/wlogin_sdk/tools/util;->cm(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static fk(Landroid/content/Context;)[B
    .locals 1
...
.method public static fl(Landroid/content/Context;)[B
    .locals 1
...
.method public static fm(Landroid/content/Context;)[B
    .locals 4
...
.method public static fn(Landroid/content/Context;)[B
    .locals 4
...
.method public static fs(Landroid/content/Context;)[B
    .locals 5
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/util;->DH(Ljava/lang/String;)[B
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1}, Loicq/wlogin_sdk/tools/util;->zl(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Loicq/wlogin_sdk/tools/util;->cm(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Loicq/wlogin_sdk/tools/util;->bg([B)Ljava/lang/String;
...
.method public static ft(Landroid/content/Context;)[B
    .locals 6
    ...
    invoke-static {v1}, Loicq/wlogin_sdk/tools/util;->DH(Ljava/lang/String;)[B
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v1}, Loicq/wlogin_sdk/tools/util;->cm(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static fu(Landroid/content/Context;)[B
    .locals 1
